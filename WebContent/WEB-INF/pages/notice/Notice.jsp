...
function getAjax(n){
	...
	$.getJSON("/ShiZunSystem/selAllNotice",{"pageSize":pageSize,"pageNumber":pageNumber,"name":name},function(pageInfo){
		...
		for(var i=0;i<notice.length;i++){
			...
			result += "<td width='8%' class='mian_b_icon_01'><a href='/ShiZunSystem/UpdateNoticeByname?name=" + notice[i].name + "'>编辑</a></td>";
...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<div class="mian_b1">
				<a href="AddNotice" title="添加"><p class="mian_b1_a1"></p>
				</a>	
				
				<a href="javascript:void(0)" title="删除" onclick="delNotice()"><p class="mian_b1_a2"></p></a>
