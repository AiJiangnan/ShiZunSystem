...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<form action="/ShiZunSystem/addDept" method="post">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
					...
					<tr>
						...
						<td width="60%"><input type="text" class="input_01" name="no" id="textfield"></td>
						<td width="25%">&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td valign="top">部门名称：</td>
						<td><input type="text" class="input_01" name="name" id="textfield"></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td valign="top">部门简称：</td>
						<td><input type="text" class="input_01" name="sname" id="textfield"></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
