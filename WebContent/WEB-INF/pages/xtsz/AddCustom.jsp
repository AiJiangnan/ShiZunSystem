...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
		<form action="/ShiZunSystem/addCustom" method="post" enctype="multipart/form-data">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
				...
				<tr>
					...
					<td width="30%"><input type="text" class="input_01" name="name" id="textfield"></td>
				...
				<tr>
					...
					<td><input type="text" class="input_01" name="url" id="textfield"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td valign="top">图标：</td>
					<td><input type="file" name="img" class="icon"> &nbsp;</td>
					<td></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td valign="top">备注：</td>
					<td colspan="2"><input type="text" class="input_01" name="remark" id="textfield"></td>
					<td></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
