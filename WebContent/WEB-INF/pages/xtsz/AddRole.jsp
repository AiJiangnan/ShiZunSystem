...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
		<form action="/ShiZunSystem/addRole" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
				...
				<tr>
					...
					<td width="20%"><input type="text" class="input_01" name="name" id="textfield"></td>
					<td width="7%">角色排序ID：</td>
					<td width="56%"><input type="text" class="input_01" name="sid" id="text1"></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="input_01" name="remark" id="textfield"></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="4">
