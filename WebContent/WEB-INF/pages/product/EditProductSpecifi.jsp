...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
		<form action="/ShiZunSystem/updsize?id=${productSize.id }" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="55%"><input type="text" class="input_01" name="name" id="textfield" value="${productSize.name }"></td>
					<td width="35%">&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td valign="top">规格备注：</td>
					<td><input type="text" class="input_01" name="remark" id="textfield" value="${productSize.remark }"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
