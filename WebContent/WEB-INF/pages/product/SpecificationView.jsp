...
function getMyPageInfo(){
	var name = $("#search").val();
	$.post("/ShiZunSystem/page3",{"pageSize":pageSize,"pageNumber":pageNumber,"name":name},function(pageInfo){
		var productSize=pageInfo.list;
		var result = "";
		var pageNum = "";
		total=pageInfo.total;
		for(var i=0;i<productSize.length;i++){
			result +="<tr>";
			result +="<td><input name='id' type='checkbox' value="+productSize[i].id+" >&nbsp; </td>";
			result +="<td>"+productSize[i].name+"</td>";
			result +="<td>"+productSize[i].remark+"</td>";
			result +="<td width='8%' class='mian_b_icon_01'><a href='/ShiZunSystem/sizebyid?id="+productSize[i].id+"'>编辑</a></td>";
			result +="<td width='8%' class='mian_b_icon_02'><a href='/ShiZunSystem/showsize?id="+productSize[i].id+"'>查看</a></td>";
			result +="</tr>";
		}
		$(".tbody").html(result);
...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<div class="mian_b1">
				<a href="AddProductSpecifi" title="添加"><p class="mian_b1_a1"></p></a>
				<a href="javascript:void(0)" title="删除" onclick="delSize()"><p class="mian_b1_a2"></p></a>
			...
			<form action="/ShiZunSystem/delsize" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mian_b_bg">
				<tr>
					...
					<td width="15%" class="mian_b_bg_lm">规格名称</td>
					<td width="35%" class="mian_b_bg_lm"><span></span>规格备注</td>
				...
				<tr>
					...
					<td width="15%" class="mian_b_bg_lm">规格名称</td>
					<td width="35%" class="mian_b_bg_lm">规格备注</td>
					<td colspan="2" class="mian_b_bg_lm"><span></span>操作</td>
				</tr>
			</table>
			</form>
