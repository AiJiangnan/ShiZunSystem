				...
				"/ShiZunSystem/showTaskPage",
						...
						function(data) {
							...
							for (var i = 0; i < data.list.length; i++) {
								...
								result += "<td>" + setDate1 +"至"+setDate+"</td>";
								result += "<td>" +(data.list[i].status==0?"未完成":"完成")+"</td>";
								result += "<td>" + cases(data.list[i].level)
										+ "</td>";
								result+="<td width='8%' class='mian_b_icon_01'><a href='/ShiZunSystem/updTask?id="+data.list[i].id+"'>编辑</a></td>";
...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<div class="mian_b1">
				<a href="AddTask" title="添加"><p class="mian_b1_a1"></p></a> <a
					href="javascript:void(0)" title="删除" onclick="del()")><p class="mian_b1_a2"></p></a>
				<p class="mian_b1_sousuo">
					<input id="tname" type="text">
				</p>
				<a href="javascript:void(0)" title="搜索" id="search"><p
						class="mian_b1_a3"></p></a> <a href="javascript:void(0)" title="最后" id="lastpage"><p
						class="mian_b1_a4"></p></a> <a href="javascript:void(0)" title="下一页" id="nextpage"><p
						class="mian_b1_a5"></p></a>
				<p class="mian_b1_list"></p>
				<a href="javascript:void(0)" title="上一页" id="prepage"><p class="mian_b1_a6"></p></a> <a href="javascript:void(0)" id="firstpage"
					title="最前"><p class="mian_b1_a7"></p></a>
			</div>
				<form action="/ShiZunSystem/delTask" method="post">
